...
public class BucketheadZombie extends Zombie{
	public BucketheadZombie(int x,int y,int rows) {
		...
		this.attack = 1;
		this.rows = rows;
		this.imageMove = Toolkit.getDefaultToolkit().createImage("src/img/Zombie/BucketheadZombie.gif");
		this.imageEat = Toolkit.getDefaultToolkit().createImage("src/img/Zombie/BucketheadZombieAttack.gif");
	}
