...
public class NormalZombie extends Zombie{
	...
	public NormalZombie(int x,int y,int rows) {
		...
		this.attack = 1;
		this.rows = rows;
		this.imageMove = Toolkit.getDefaultToolkit().createImage("src/img/Zombie/Zombie.gif");
		this.imageEat = Toolkit.getDefaultToolkit().createImage("src/img/Zombie/ZombieAttack.gif");
	}
