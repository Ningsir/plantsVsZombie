...
public class FlagZombie extends Zombie{
	public FlagZombie(int x,int y,int rows) {
		...
		this.attack = 1;
		this.rows = rows;
		this.imageMove = Toolkit.getDefaultToolkit().createImage("src/img/Zombie/FlagZombie.gif");
		this.imageEat = Toolkit.getDefaultToolkit().createImage("src/img/Zombie/FlagZombieAttack.gif");
	}
